 ...
 * -----------------------------------------
 * Define an object of the class Polyline and
 * its properties.
 */
...
public class Polyline {
    ...
    /**
     * Get the vertices of the polyline. The objects are copied.
    ...
    public void addBefore(Point vertex, String vertexName) {
        Point newVertex = new Point(vertex); // Make a new copy of the object referenced
        ...
        for (int i = 0; i < newVertices.length - 1; i++) {
            newVertices[i < index ? i : i + 1] = this.vertices[i];
        }
    ...
    /**
     * Remove a specific vertex from the polyline.
     * @param vertexName is the name of the vertex to remove
     */
    public void remove(String vertexName) {
        ...
        for (int j = 0; j < index; j++) {
            newVertices[j] = this.vertices[j];
        }
        for (int j = index; j < newVertices.length; j++) {
